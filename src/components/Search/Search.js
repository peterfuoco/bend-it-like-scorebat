      ...
      <Form onSubmit={props.submit} className="form" id="form-reset">
        <Form.Group className="mb-3">
          ...
          <Form.Control
            ...
            id="team"
          />
          <Form.Text className="text-muted">e.g. Cambridge United</Form.Text>
        </Form.Group>
        <Form.Group className="mb-3">
          <Form.Label>Event/League</Form.Label>
          <Form.Control type="text" placeholder="Enter event/league" />
          <Form.Text className="text-muted">
            e.g. ENGLAND: League Cup{" "}
          </Form.Text>
        </Form.Group>
        <Form.Group className="mb-3" type="date" name="date" id="date">
          <Form.Label>Date</Form.Label>
          <Form.Control type="date" placeholder="Enter date" />
          <Form.Text className="text-muted">e.g. 08/25/2021 </Form.Text>
        </Form.Group>
